        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm space-y-5">
          ...
          <div className="max-w-xl space-y-4">
            ...
            <div>
              ...
              >
                <option value="gemini-3.7-flash">Gemini 3.7 Flash (Ultra Fast / Latest)</option>
                <option value="gemini-3.5-flash">Gemini 3.5 Flash</option>
                <option value="gemini-3.1-pro">Gemini 3.1 Pro (Deep Career Specialist)</option>
                <option value="gemini-2.0-flash">Gemini 2.0 Flash (Recommended Standard)</option>
                <option value="gemini-2.0-flash-thinking-exp-01-21">Gemini 2.0 Flash Thinking (Deep Reasoning)</option>

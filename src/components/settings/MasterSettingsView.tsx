        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm space-y-5">
          ...
          <div className="max-w-xl space-y-4">
            ...
            <div>
              ...
              >
                <option value="gemini-3.7-flash">Gemini 3.7 Flash — 1M Context, Agentic & Fast (Recommended)</option>
                <option value="gemini-3.6-flash">Gemini 3.6 Flash — Fast Multitask Workhorse</option>
                <option value="gemini-2.0-flash">Gemini 2.0 Flash — High-Speed Multimodal</option>
                <option value="gemini-2.0-flash-thinking-exp-01-21">Gemini 2.0 Flash Thinking — Deep Analytical Reasoning</option>
                <option value="gemini-1.5-pro">Gemini 1.5 Pro — 2M Massive Context Analysis</option>
                <option value="gemini-1.5-flash">Gemini 1.5 Flash — Ultra-Lightweight & Fast</option>
              </select>
            </div>
          </div>
        </div>
